...
import 'package:pekato/pages/role/administator/pages/data_user/data_masyarakat.dart';
import 'package:pekato/pages/role/administator/pages/data_user/data_petugas.dart';
import 'package:pekato/pages/role/administator/pages/laporan/list_laporan.dart';
import 'package:pekato/pages/role/administator/pages/tambah_petugas.dart';
import 'package:pekato/pages/role/user/pages/form/form_laporan.dart';
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const DataPetugas()));
                    },
                    child: Container(
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20.0),
