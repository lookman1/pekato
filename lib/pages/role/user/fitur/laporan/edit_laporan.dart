...
class EditLaporan extends ConsumerStatefulWidget {
  final Map<dynamic, dynamic> laporan;
  const EditLaporan({super.key, required this.laporan});

  @override
  ConsumerState<EditLaporan> createState() => _EditLaporanState();
}

class _EditLaporanState extends ConsumerState<EditLaporan> {
  ...
  void initState() {
    super.initState();
    nik.text = widget.laporan['nik_laporan'];
    tempat.text = widget.laporan['tempat_laporan'];
    tanggal.text = widget.laporan['tanggal_laporan'];
    isi.text = widget.laporan['isi_laporan'];
    foto = widget.laporan['foto_laporan'];
  }
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            disabledBorder: const OutlineInputBorder(
                                borderSide:
                                    BorderSide(width: 1.0, color: green3),
                                borderRadius:
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                                borderSide:
                                    BorderSide(color: green3, width: 2.0),
                                borderRadius:
                                    BorderRadius.all(Radius.circular(8.0))),
